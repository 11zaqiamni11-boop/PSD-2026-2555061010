...
12. **`        n = int(input("Masukkan jumlah tumpukan struk/nota: "))`**
...
17. **`    print("Masukkan rincian struk:")`**
...
20. **`        nama = input("Keterangan/Nama Struk (misal: Laundry, Makan): ")`**
...
27. **`                print("Input tidak valid, silakan masukkan angka untuk tanggal!")`**
    Mencetak peringatan. Setelah ini, program otomatis mengulang ke baris 21 untuk menanyakan tanggal kembali.
28. **`    print("Kondisi Tumpukan Struk SEBELUM diurutkan:")`**
